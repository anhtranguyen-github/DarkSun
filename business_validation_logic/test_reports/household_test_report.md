...
| 5 | Thay đổi chủ hộ | Reset người cũ | Xử lý chuẩn | PASS |
...
| 11 | Đổi chủ hộ không thuộc hộ | 400 | Xử lý chuẩn | PASS |
...
| 18 | Transaction rollback | Rollback | Xử lý chuẩn | PASS |
| 19 | Update householdCode trùng | 409 | Xử lý chuẩn | PASS |
| 20 | Concurrent create | Chỉ 1 thành công | Xử lý chuẩn | PASS |
| 21 | SQL Injection filter | Chặn | Xử lý chuẩn | PASS |

---

### Tổng kết: 19 PASS | 2 FAIL

**Các lỗi đã sửa trong phiên bản này:**
- ✅ Delete cascade check (residents)
- ✅ Delete cascade check (vehicles)
- ✅ Delete cascade check (unpaid invoices)
