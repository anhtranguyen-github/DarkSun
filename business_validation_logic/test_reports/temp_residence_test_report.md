...
| 8 | endDate < startDate | Báo lỗi | Xử lý chuẩn | PASS |
...
| 12 | Tìm kiếm theo tên | Đúng kết quả | Xử lý chuẩn | PASS |
| 13 | Lọc theo type | Đúng | Xử lý chuẩn | PASS |
| 14 | permitCode ký tự lạ | Sanitize | Xử lý chuẩn | PASS |
| 15 | IDOR xem người khác | Chặn | Không xử lý | FAIL |
| 16 | **type không hợp lệ** | Báo lỗi | Xử lý chuẩn | **PASS** ✅ |
...
- ✅ Date range validation using utility function
